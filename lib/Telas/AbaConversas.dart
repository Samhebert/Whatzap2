...
class _AbaConversasState extends State<AbaConversas> {
  ...
  List<Conversa> listaConversa = [
    ...
    Conversa(
        "Pedro Silva",
        "Me manda o nome daquela serie que falamos?",
    ...
    Conversa(
        "Jamilto Damasceno",
        "Tem curso novo, depois da uma olhada",
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder:(context, indice){
        ...
        return ListTile(contentPadding: EdgeInsets.fromLTRB(16, 8, 16, 8),
        ...
        subtitle: Text(conversa.mensaem, style : TextStyle(
          color: Colors.grey,
          fontSize: 14
        )));
